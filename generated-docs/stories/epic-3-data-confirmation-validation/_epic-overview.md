...
2. **Data Confirmation - Other Checks Tab** - Validate reference data (instruments, prices, ratings, durations, betas)
   - File: `story-2-other-checks-tab.md`
   - Status: Pending

3. **Data Confirmation - Portfolio Re-imports Tab** - Manage re-import status
